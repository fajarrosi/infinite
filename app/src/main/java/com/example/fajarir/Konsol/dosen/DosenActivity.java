package com.example.fajarir.Konsol.dosen;
...
public class DosenActivity extends AppCompatActivity {
    ...
    private DosenPagerAdapter dosenPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dosenPagerAdapter = new DosenPagerAdapter(getSupportFragmentManager(),this);
        mViewPager.setAdapter(dosenPagerAdapter);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Logout", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Qiscus.clearUser();
                            dataManager.clear();
                            startActivity(new Intent(DosenActivity.this, MainActivity.class));
                            finish();
                        }
                    })
    ...
    public class DosenPagerAdapter extends FragmentPagerAdapter {
        ...
        public DosenPagerAdapter(FragmentManager fm, Context c) {
            super(fm);
            mContext = c;
